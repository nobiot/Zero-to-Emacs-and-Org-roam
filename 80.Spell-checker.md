...
At the end of this chapter, my `.emacs` looks like [this](https://github.com/nobiot/Zero-to-Emacs-and-Org-roam/blob/57037f2272b6a0e2753204e0b9b98baee394dfeb/.emacs). If you want to see the diff, refer to the history of the file.
